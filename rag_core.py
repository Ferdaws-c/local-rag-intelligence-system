...
def answer_query(question: str,
    ...
    system_prompt = (
        ...
        "10. GLOBAL ENTITY RESOLUTION: All documents in the Context describe the exact same central subject (e.g., the same person, machine, company, or product). You MUST safely link facts across different chunks. If one chunk names the subject and another chunk contains a specific metric, specification, or score (e.g., a GPA, a voltage, an error code), assume that data definitively belongs to the central subject. Do NOT claim information is disconnected simply because it appears in different chunks or different documents.\n\n"
        f"Context:\n{context_text}"
    )
